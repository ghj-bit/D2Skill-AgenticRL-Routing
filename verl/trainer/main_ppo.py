...
def run_ppo(config) -> None:
    ...
    # os.environ['SWANLAB_API_KEY'] = 'Trq2Hel0CXPmZLpyH2xNC'
    # 在代码中打印
    logger.info("开始执行。。。")
    os.environ['WANDB_API_KEY'] = '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'
